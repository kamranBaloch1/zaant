...
class NotificationsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(backgroundColor: appBarColor, title: "Notifications"),
...
class NotificationList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: NotificationMethod().getNotificationStream(),
        ...
        if (!snapshot.hasData || snapshot.data == null || snapshot.data!.isEmpty) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final notificationSenderProfilePicUrl = notification['userProfilePicUrl'] as String;
              final notificationIsSeen = notification['isSeen'] as bool;
              final notificationId = notification['notificationId'] as String;
              final notificationDate = notification['notificationDate'] as Timestamp;
              final formattedDate = DateFormat.yMMMd().format(notificationDate.toDate());

              // Define a color for the Card based on whether the notification is seen or not
              final cardColor = notificationIsSeen ? Colors.white : const Color.fromARGB(31, 189, 186, 186);
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                    radius: 30.sp,
                    backgroundImage: NetworkImage(notificationSenderProfilePicUrl),
                  ),
                  title: Text(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () {
                      ...
                      CustomAlertDilog.show(
                        ...
                        onConfirm: () async {
                          await NotificationMethod().markNotificationAsRead(notificationId: notificationId);
                        },
                      );
                    },
                  ),
